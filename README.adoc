...
The current 1.3 release branch will see further bugfix upgrades for as long as https://spring.io/projects/spring-boot#support[Spring Boot 2.7 is under open-source support].
